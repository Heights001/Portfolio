  ...
  return (
    <section id="contact" className="p-6 max-w-7xl mx-auto bg-gray-100 mt-10">
      ...
      <p className="text-gray-700 max-w-2xl mb-10">
        Reach out to me for collaborations, inquiries, or just to say hi! I am always open to discussing new projects, creative ideas, or opportunities to be part of your visions. Fill out the form below and I'll get back to you as soon as possible.
      </p>
